...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkGooglePlayServices() == false) {
            // exit
            Toast.makeText(this, "No Google Play Services detected", Toast.LENGTH_LONG).show();
        }
    ...
    public void onSearch(View view){
        ...
        if(location != null || !location.equals("")){
            ...
            if(addressList == null || addressList.isEmpty()){
                ...
                //alertDialogBuilder.setMessage("Please specify an address");
                alertDialogBuilder.setCancelable(true);
                alertDialogBuilder.setTitle("Pick address")
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private LocationRequest mLocationRequest;
    private Location mLastLocation;
    private GoogleMap.OnMapClickListener myOnMapClickListener;
    private Marker mCurrLocationMarker;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(30.3142, -97.7329);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Austin"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    }
